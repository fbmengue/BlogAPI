...
public class AccountController : ControllerBase
{
    ...
    public async Task<IActionResult> Post(
        ...
        {
            return StatusCode(400, new ResultViewModel<string>("05EX99 - Este E-mail ja esta cadastrado"));

        }
        catch
        {
            return StatusCode(400, new ResultViewModel<string>("05EX98 - Falha interna no servidor"));
        ...
        [FromServices]TokenService tokenService)
    {
        ...
        {
            return StatusCode(500, new ResultViewModel<string>("05EX95 - Falha interna no servidor"));
        ...
        [FromServices] BlogDataContext context)
    {
        ...
        {
            return StatusCode(500, new ResultViewModel<string>("05x87 - Falha interna no servidor"));
        }
